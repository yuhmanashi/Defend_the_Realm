...
/***/ "./src/towers/tower_util.js":
/*!**********************************!*\
  !*** ./src/towers/tower_util.js ***!
  \**********************************/
/***/ ((module) => {

eval("const TowerUtil = {\n    generateImages(tower, action, numImages = 10){\n        const images = [];\n        for (let i = 0; i < numImages; i++){\n            images.push(`towers/${tower}/${action}/${i}`)\n        }\n        return images\n    }\n}\n\nmodule.exports = TowerUtil;\n\n//# sourceURL=webpack://Defend_the_Realm/./src/towers/tower_util.js?");
